...
class BotSwitcherService {
    ...
    private customStake: number = 0; // User-defined stake to apply to both bots
    ...
    /**
     * Set custom stake to apply to both bots
     */
    ...
    /**
        ...
        private async saveCurrentStake(): Promise<void> {
                try {
                    // If custom stake is set, use it instead of reading from workspace
