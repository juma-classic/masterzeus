...
const ModernLoader: React.FC<ModernLoaderProps> = ({ onFinish }) => {
    ...
    const tradingTips = [
        ...
        'ZEUS TRADING - Your path to financial freedom',
    ...
    useEffect(() => {
        ...
        const loadingPhases = [
            ...
            { duration: 500, text: 'Welcome to ZEUS TRADING', progress: 100 },
        ];
        ...
        <div className='modern-loader zeus-loader'>
            ...
            <div className='zeus-loader__content'>
                ...
                <h1 className='zeus-loader__brand'>
                    ...
                    <span className='zeus-loader__brand-trading'>TRADERS DEN</span>
                </h1>
